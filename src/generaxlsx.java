...
/**
 * Calculadora de préstamos. genera un fichero xlsx con fórmulas
 *
 * Uso:
 *   generaxlsx -xls|xlsx
 *
...
public class generaxlsx {
	public static void main(String[] args) throws Exception {
        ...
        titleCell.setCellValue("Calculadora de préstamos");
        ...
        cell.setCellValue("Cantidad del préstamo");
        ...
        cell = row.createCell(2);
        cell.setCellValue("Periodo de préstamo en años");
        cell.setCellStyle(styles.get("item_left"));
        cell = row.createCell(4);
        ...
        cell = row.createCell(2);
        cell.setCellValue("Fecha Inicio de préstamo");
        cell.setCellStyle(styles.get("item_left"));
        cell = row.createCell(4);
        ...
        cell = row.createCell(2);
        cell.setCellValue("Interés Total");
        cell.setCellStyle(styles.get("item_left"));
        cell = row.createCell(4);
        ...
        cell = row.createCell(2);
        cell.setCellValue("Coste total del préstamo");
        cell.setCellStyle(styles.get("item_left"));
        cell = row.createCell(4);
